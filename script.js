...
const turnsDisplay = document.getElementById('turn-count'); // Updated ID
const timeDisplay = document.getElementById('timer'); // Updated ID
const playAgainButton = document.getElementById('play-again-btn'); // Updated ID
const celebration = document.getElementById('celebrationModal'); // Modal ID
const finalTurnsDisplay = document.getElementById('final-turns'); // Final turns
const finalTimeDisplay = document.getElementById('final-time'); // Final time
...
// End the game
// Play again button click for modal
const playAgainModalButton = document.getElementById('play-again-modal-btn');

playAgainModalButton.addEventListener('click', () => {
  resetGame();
  $('#celebrationModal').modal('hide'); // Close the modal after playing again
});

// End the game
function endGame() {
  clearInterval(timerInterval);
  $('#celebrationModal').modal('show'); // Show the modal when the game ends
